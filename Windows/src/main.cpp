...
int main(int argc, char **argv)
{
    ...
    try {
    	// Sets polygons resolution. Reads from config polygonL1Resolution and polygonL2Resolution
    	// This allows easy access from the polygonOptimizer without parameter-passing in all optimizePolygons calls
    	processor.setPolygonsResolution();
